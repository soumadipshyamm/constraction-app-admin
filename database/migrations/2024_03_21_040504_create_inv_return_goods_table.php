...
return new class extends Migration
{
    ...
    {
        Schema::create('inv_return_goods', function (Blueprint $table) {
            $table->id();
            $table->uuid('uuid')->unique();
            $table->foreignId('inv_returns_id')->nullable()->references('id')->on('inv_returns')->onDelete('cascade');
    ...
    {
        Schema::dropIfExists('inv_return_goods');
    }
};
