...
return new class extends Migration
{
    ...
    {
        Schema::create('inv_inwards', function (Blueprint $table) {
            $table->id();
            ...
            $table->foreignId('store_id')->nullable()->references('id')->on('store_warehouses')->onDelete('cascade');
    ...
    {
        Schema::dropIfExists('inv_inwards');
    }
};
