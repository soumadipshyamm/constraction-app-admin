...
return new class extends Migration
{
    ...
    {
        Schema::create('inv_issues_details', function (Blueprint $table) {
            $table->id();
            $table->uuid('uuid')->unique();
            $table->foreignId('inv_issue_goods_id')->nullable()->references('id')->on('inv_issue_goods')->onDelete('cascade');
    ...
    {
        Schema::dropIfExists('inv_issues_details');
    }
};
