...
use App\Http\Resources\Export\AssetesOpenStockExportResources;
...
class ExportAssesOpeningStock implements FromCollection, WithHeadings, ShouldAutoSize, WithEvents
{
    protected  $selects;
    protected  $row_count;
    ...
    public function collection()
    {
        ...
        // dd($companyId);
        // $labours = AssetsOpeningStock::with('projects', 'stores', 'assets')->where('company_id', $companyId)->get();
        $labours = Assets::with('project', 'units', 'store_warehouses')->where('company_id', $companyId)->get();
        $collection = AssetesExportResources::collection($labours);
        // dd($labours);
        // $collection = AssetesOpenStockExportResources::collection($labours);
