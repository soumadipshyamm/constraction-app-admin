...
class StoreWarehouseController extends BaseController
{
    public function list(Request $request)
    {
        ...
        $data = StoreWarehouse::with('project')->where('company_id', $authCompany?->company_id)->get();
    ...
    {
        $authCompany = Auth::guard('company-api')->user()->company_id;
        $data = StoreWarehouse::where('id', $uuid)->where('company_id', $authCompany)->get();
        $message = $data->isNotEmpty() ? 'Fetch Store/Warehouse List Successfully' : 'Store/Warehouse List Data Not Found';
