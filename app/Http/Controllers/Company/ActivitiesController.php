...
class ActivitiesController extends BaseController
{
    ...
    public function addCopyActivites(Request $request)
    {
        ...
        $to_subproject = $fetchDatas['to_subproject'];
    ...
    //     $to_project = $fetchDatas['to_project'];
    //     $findId = [];
    //     foreach ($fetchDatas as $key => $data) {
    //         if (is_array($data)) {
    //             foreach ($data as $k => $dataValue) {
    //                 $i = 0;
    //                 $findId[] = Activities::where('company_id', $companyId)
    //                     ->where('id', $dataValue)
    //                     ->get();
    //                 $i++;
    //             }
    ...
    //     foreach ($finalData as $key => $dataValue) {
    //         $datass = [
    //             'uuid' => Str::uuid(),
    //             'project_id' => $to_project,
    //             'subproject_id' => $to_subproject,
    //             // 'sl_no' => $dataValue->slno,
    //             'type' => $dataValue->type,
    //             'activities' => $dataValue->activities,
    //             'unit_id' => $dataValue->unit_id ?? '',
    ...
    //             'company_id' => $companyId ?? '',
    //         ];
    //         $isUpdated = Activities::insert($datass);
    //     }
    //     dd($isUpdated);
    //     // dd($findId1);
    // }
    ...
    // public function addCopyActivities(Request $request)
    // {
    //     $authCompany = Auth::guard('company')->user();
    //     $companyId = searchCompanyId($authCompany->id);
    ...
    //     // Find activities by their IDs
    //     $activityIds = collect($fetchDatas)->flatMap(function ($data) {
    ...
    //     // Create new activities with copied data
    //     $newActivities = $activities->map(function ($activity) use ($to_project, $to_subproject, $companyId) {
    //         return [
    //             'uuid' => Str::uuid(),
    //             'project_id' => $to_project,
    //             'subproject_id' => $to_subproject,
    ...
    //     Activities::insert($newActivities->toArray());

    //     // Optionally, you can return a response or redirect
    //     return response()->json(['success' => true, 'message' => 'Activities copied successfully']);
    // }
}
