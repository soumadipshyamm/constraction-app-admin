...
class InvIssue extends Model
{
    ...
    {
        return $this->belongsToMany(StoreWarehouse::class, 'inv_issue_stores', 'inv_issues_id', 'store_warehouses_id');
    }
    public function invIssueGoods()
    {
        return $this->hasMany(InvIssueGood::class, 'inv_issues_id', 'id');
    }
}
