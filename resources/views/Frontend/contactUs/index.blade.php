                ...
                <div class="col-md-6 col-12">
                    <div class="contact-us-left">
                        ...
                        <ul>
                            ...
                            <li><a><span class="icon"><i class="fa fa-map-marker" aria-hidden="true"></i></span>Visit Us
                                    <br><span class="details"> {{ $contactDetails?->address ?? '' }}</span> </a></li>
                        </ul>
                    </div>
                </div>
                <div class="col-md-6 col-12">
                        ...
                        <form method="POST" action="{{ route('contactUs') }}" class="formSubmit fileUpload"
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12 col-sm-12 col-12">
                                    ...
                                    <div class="form-group">
                                        <textarea cols="40" rows="3" name="message" id="message" class=" form-control"
