        ...
        <div class="app-page-title">
            <div class="page-title-wrapper">
                ...
                <div class="page-title-actions">
                    ...
                    <a href="{{ route('admin.roleManagment.role') }}" type="button" class="btn-shadow btn btn-info">
                        Add New Role
                    </a>
                    @endif
                </div>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="{{ route('admin.roleManagment.edit',$data->id) }}"><i
                                                    class="fa fa-edit" style="cursor: pointer;" title="Edit"> </i></a>
                                            <a href="{{ route('admin.roleManagment.add',$data->id)}}"><i
                                            ...
                                            <a class="deleteData text-danger" data-uuid="{{ $data->id }}"
                                                data-table="admin_roles" href="javascript:void(0)"><i
