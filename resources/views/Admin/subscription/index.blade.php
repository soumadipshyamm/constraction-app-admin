                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <p>₹ {{ $data->amount_inr }}/{{ $data->payment_mode }}
                                                <br>Trial:
                                                <span style="color: red">{{ $data->trial_period }}
                                                    Days</span>
                                            </p>
                                            @else
                                            <p>------</p>
                                        ...
                                        <td>
                                            <a href="{{ route('admin.subscription.edit', $data->uuid) }}"><i class="fa fa-edit" style="cursor: pointer;" title="Edit"></i></a>
                                            <a href="{{ route('admin.subscription.editSubscriptionOption', $data->uuid) }}"><i class="fa fa-cog" style="cursor: pointer;" title="Manage Permission"></i></a>

                                            <a class="deleteData text-danger" data-uuid="{{ $data->uuid }}" data-table="subscription_packages" href="javascript:void(0)"><i class="fa fa-trash-alt" style="cursor: pointer;" title="Remove">
                                                </i></a>
                                        </td>
                                    </tr>
                                    @empty
