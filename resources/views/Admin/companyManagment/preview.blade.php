                                ...
                                <table class="mb-0 table ">
                                    <tbody>
                                        ...
                                        @if ($datas)
                                            ...
                                            <tr>
                                                <td>Name</td>
                                                <td>{{ $datas->companyuser[0]->name }}</td>
                                            </tr>
                                            <tr>
                                                <td>Phone</td>
                                                <td>{{ $datas->companyuser[0]->phone }}</td>
                                            </tr>
                                            <tr>
                                                <td>Email</td>
                                                <td>{{ $datas->companyuser[0]->email }}</td>
                                            </tr>
                                            <tr>
                                                <td>Designation</td>
                                                <td>{{ $datas->companyuser[0]->designation }}</td>
                                            </tr>
                                            <tr>
                                                <td>Date of Birth</td>
                                                <td>{{ $datas->companyuser[0]->dob }}</td>
                                            </tr>
                                            <tr>
                                                <td>Country</td>
                                                <td>{{ $datas->companyuser[0]->country }}</td>
                                            </tr>

                                            <tr>
                                                <td>City</td>
                                                <td>{{ $datas->companyuser[0]->city }}</td>
                                            </tr>
                                            <tr>
                                                <td>Role</td>
                                                <td>{{ companyroleidtoname($datas->companyuser[0]->company_role_id, 'company_roles') }}
                                                </td>
                                            </tr>
                                            <tr>
