...
<body>
    ...
    {{-- <a href="{{ route('page') }}" type="button" class="btn-shadow btn btn-info">
        Add User
    </a> --}}
    {{-- <a href="{{ route('page') }}">Home</a> --}}
    {{-- {{ dd(auth()->user()->userPermission[0]->menu) }} --}}

    {{-- @foreach (auth()->user()->userPermission as $myMenu) --}}
    {{-- @php
    print_r($key);
    @endphp --}}
    ...
    {{-- @endforeach
    @endforeach --}}
    <h3><a href="{{ route('admin.home') }}">Dashboard</a></h3>
