...
@section('issueSlip-active', 'active')
@section('title', __('Issue Slip'))
@push('styles')
@endpush
@section('content')
                            ...
                            <div class="main_card mb-3">
                                <div class="card_content">
                                    <div class="tab-content" id="nav-tabContent">
                                        <form id="form-report-inventory-issue-slips" class="filter-form"
                                            ...
                                            <div class="tab-content" id="pills-tabContent">
                                                <div class="processdetails_box">
                                                    <div class="process_table">
                                                        <div class="table-responsive" id="formReportInventoryIssueSlips">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            function sendAjaxRequest() {
                ...
                // AJAX request
                $.ajax({
                    url: baseUrl + `ajax/get-inventory-issue-slips`,
                    type: "POST",
                    headers: {
                    ...
                    success: function(response) {
                        ...
                        // alert(type);
                        formReportInventoryIssueSlips(response.assets)
                    },
            ...
            $(document).on('change', '#form-report-inventory-issue-slips', function() {
                // alert("jhgfdsdfghjkl")
                sendAjaxRequest();
            });
        });
        // ****************************************************************************************
        function formReportInventoryIssueSlips(data) {
            // alert(JSON.stringify(data))
            let tableBody = $('#formReportInventoryIssueSlips');
            tableBody.empty();
            let tableHtml = `<table class="table table-bordered " id="formReportInventoryIssueSlipsTable">
                                    <thead>
            ...
            $('#formReportInventoryIssueSlipsTable').DataTable({
                destroy: true,
                paging: true,
                searching: true,
                ordering: true,
        ...
        $('#form-report-inventory-issue-slips').change(function() {
