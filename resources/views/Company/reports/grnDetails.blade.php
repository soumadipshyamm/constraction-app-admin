...
@section('grnDetails-active', 'active')
@section('title', __('GRN Details'))
@push('styles')
@endpush
@section('content')
                            ...
                            <div class="main_card mb-3">
                                <div class="card_content">
                                    <div class="tab-content" id="nav-tabContent">
                                        <form id="form-report-inventory-grn-details" class="filter-form"
                                            ...
                                            <div class="tabcin_head">
                                                <div class="d-flex justify-content-between">
                                                    ...
                                                    <div class="singletabcin_head_rfq">
                                                        <label for="">From Supplier:</label>
                                                        <select class="form-control mySelect22 supplier"
                                                            value="{{ old('supplier') }}" name="supplier" id="supplier">
                                            ...
                                            <div class="tab-content" id="pills-tabContent">
                                                <div class="processdetails_box">
                                                    ...
                                                    <div class="process_table">
                                                        <div class="table-responsive" id="formReportInventoryGrnDetails">
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            function sendAjaxRequest() {
                ...
                // AJAX request
                $.ajax({
                    url: baseUrl + `ajax/get-inventory-grn-details`,
                    type: "POST",
                    headers: {
                    ...
                    success: function(response) {
                        ...
                        // alert(type);
                        formReportInventoryGrnDetails(response.assets)
            ...
            $(document).on('change', '#form-report-inventory-grn-details', function() {
                sendAjaxRequest();
            });
        });

        // ****************************************************************************************
        function formReportInventoryGrnDetails(data) {
            // alert(JSON.stringify(data))
            let tableBody = $('#formReportInventoryGrnDetails');
            tableBody.empty();
            let tableHtml = `<table class="table table-bordered " id="formReportInventoryGrnDetailsTable">
                                    <thead>
            ...
            if (data) {
                ...
                <tr>
                    ...
                    <td>${stock.unit || ' '}</td>
                    <td>${stock.receipt_qty || 0}</td>
                    <td>${stock.reject_qty || 0}</td>
                    <td>${stock.accepted_qty || 0}</td>
                    <td>${stock.rate || 0}</td>
                    <td>${stock.amount || 0}</td>
                    <td>${stock.po_qty || 0}</td>
                    <td>${stock.po_balance || 0}</td>
                    <td>${stock.remarks || ' '}</td>
                </tr>`;
                });
            } else {
            ...
            $('#formReportInventoryGrnDetailsTable').DataTable({
                destroy: true,
                paging: true,
                searching: true,
                ordering: true,
        ...
        $('#form-report-inventory-grn-details').change(function() {
