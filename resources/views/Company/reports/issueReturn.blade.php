...
@section('issueReturn-active', 'active')
@section('title', __('Issue Return'))
@push('styles')
@endpush
@section('content')
                            ...
                            <div class="main_card mb-3">
                                <div class="card_content">
                                    <div class="tab-content" id="nav-tabContent">
                                        <form id="form-report-inventory-issue-return" class="filter-form"
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            function sendAjaxRequest() {
                ...
                // AJAX request
                $.ajax({
                    url: baseUrl + `ajax/get-inventory-issue-return`,
                    type: "POST",
                    headers: {
            ...
            $(document).on('change', '#form-report-inventory-issue-return', function() {
                sendAjaxRequest();
            });
        });
        ...
        function formReportInventoryProjectStockmaterial(data) {
            ...
            let tableHtml = `<table class="table table-bordered " id="formReportInventoryProjectStockmaterialTable">
                                    <thead>
                                        ...
                                        <th scope="col">Machine/Tool Yet <br>to return qty </th>
            ...
            if (data) {
                ...
                $.each(data, function(key, stock) {
                    ...
                    tableHtml += `
                   <tr>
                        <td>${stock.return_no !== null ? stock.return_no : ' '}</td>
                        ...
                        <td>${stock.return_qty !== null ? stock.return_qty : ' '}</td>
                        <td>${stock.entry_by !== null ? stock.entry_by : ' '}</td>
                        <td>${stock.stock_qty !== null ? stock.stock_qty : ' '}</td>
                        <td>${stock.stock_qty !== null ? stock.issue_to : ' '}</td>
                    </tr>`
                });
            } else {
        ...
        $('#form-report-inventory-issue-return').change(function() {
