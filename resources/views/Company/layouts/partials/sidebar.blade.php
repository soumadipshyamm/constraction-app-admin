            ...
            @if ($isSubscribed)
                <ul class="vertical-nav-menu">
                    ...
                    @if ($hasPermission('subscription'))
                        <li class="app-sidebar__heading">Project Permissions</li>
                        <li class="{{ isActiveRoute($userManagementRoutes, 'mm-collapse mm-show') }}">
                            <a href="{{ route('company.projectPermission.list') }}">
                                <span>
                                    <img src="{{ asset('company_assets/images/side-icon/master.svg') }}"
                                        class="img-fluid" alt="Project Permissions">
                                </span>
                                Project Permissions
                            </a>
                        </li>
                    ...
                    @php
                        ...
                        $hasWorkContractorReports = $hasPermission('contractor-reports');
                        $hasAnyReports = $hasWorkProgressReports || $hasWorkContractorReports || $hasInventoryReports;
                    @endphp
                    ...
                    {{-- @if ($hasLabourStrength) --}}
                        <li class="app-sidebar__heading">
                            <a href="{{ route('company.report.labourStrength') }}">
                                <span>
                                    <img src="{{ asset('company_assets/images/side-icon/master.svg') }}"
                                        class="img-fluid" alt="Labour Strength">
                                </span>
                                Labour Strength
                            </a>
                        </li>
                    ...
                    {{-- @if ($hasWorkContractor) --}}
                        <li class="app-sidebar__heading">
                            <a href="{{ route('company.report.workContractor') }}">
                                <span>
                                    <img src="{{ asset('company_assets/images/side-icon/master.svg') }}"
                                        class="img-fluid" alt="Work Contractor">
                                </span>
                                Work Contractor
                            </a>
                        </li>
