...
<div class="app-main__outer">
    <div class="app-main__inner card">
        ...
        <div class="dashboard_body">
            ...
            {{-- @dd($data->toArray()); --}}
            <form method="POST" action="{{ route('company.project.add') }}" data-url="{{ route('company.project.add') }}" class="formSubmit fileUpload" enctype="multipart/form-data" id="UserForm">
                @csrf
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" value="{{ old('project_name', $data->project_name ?? '') }}" name="project_name" id="project_name" placeholder=" Enter Your Project Name">
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="date" class="form-control" name="planned_start_date" value="{{ old('planned_start_date', $data->planned_start_date ?? '') }}" id="planned_start_date" placeholder="Enter Planned Start Date">
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="text" name="address" id="address" class="form-control" value="{{ old('address', $data->address ?? '') }}" placeholder=" Enter  Address">
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="date" class="form-control" name="planned_end_date" value="{{ old('planned_end_date', $data->planned_end_date ?? '') }}" id="planned_end_date" placeholder="Enter Planned Start Date">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="comapny-check">
                            <input class="form-check-input clientPoint" type="radio" name="own_project_or_contractor" id="own_project_or_contractor_yes" value="{{ old('own_project_or_contractor', 'yes') }}" {{ !empty($data) ?? $data->own_project_or_contractor == 'yes' ? 'checked' : '' }}>
                            <label class="form-check-label" for="flexCheckIndeterminate">
                                yes
                            </label>
                            <input class="form-check-input clientPoint" type="radio" name="own_project_or_contractor" id="own_project_or_contractor_yes" value="{{ old('own_project_or_contractor', 'no') }}" {{ !empty($data) ?? $data?->own_project_or_contractor == 'no' ? 'checked' : '' }}>
                            <label class="form-check-label" for="flexCheckIndeterminate">
                                No
                            </label>
                    ...
                    <div class="col-md-3">
                        ...
                        <select class="form-select" value="{{ old('tag_company') }}" name="tag_company" id="multiple-select-field" data-placeholder="Choose anything" multiple>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="intermediate-check">
                                ...
                                <input class="form-check-input" type="checkbox" name="project_completed" id="project_completed" value="{{ old('project_completed', 'yes') }}" {{ isset($data) && $data->project_completed == 'yes' ? 'checked' : '' }}>
                            ...
                            <div class="uploadimage">
                                <h6>
                                    <i class="fa mr-2" aria-hidden="true">
                                        <img src="{{ asset('logo/' . $data->logo) }}" alt="" width="80" height="80" id="display_picture"></i>Current Image
                                </h6>
                            </div>
                        </div>
                    </div>
