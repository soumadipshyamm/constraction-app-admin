...
<div class="company-info">
    <div class="accordion-item">
        ...
        <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="constgOne" data-bs-parent="#accordionExample">
            <div class="accordion-body">
                ...
                <div class="col-md-6">
                    ...
                    <div class="tag_company">
                        ...
                        <a href="#" class="tag-com">{{ $data->companys->registration_name ?? '' }}</a>
                    </div>
                </div>

                <div class="col-12 d-flex justify-content-end">
                    <div class="compaction_btn">
                        <a href="{{ route('company.project.edit', $data->uuid ?? '') }}" class="btn btn-primary">Edit</a>
                        <a class="btn btn-secondary deleteData text-danger" data-model="company" data-uuid="{{ $data->uuid ?? '' }}" data-table="projects" href="javascript:void(0)">Delete</a>
                    </div>
                </div>
            </div>
        </div>
