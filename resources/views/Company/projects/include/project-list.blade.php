                    ...
                    <div class="accordion-body">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="tag_company">
                                    <h6><span>Project Permission Members</span></h6>

                                    {{-- @dd($data->projectMemberAllocation); --}}
                                    @if (count($data?->projectMemberAllocation) > 0)
                                        @foreach ($data?->projectMemberAllocation as $member)
                                            {{-- @dd($member->user->name); --}}
                                            <a href="#" class="tag-com">{{ $member?->user?->name }}</a>
                                        @endforeach
                                        <p><a href="{{ route('company.projectPermission.list') }}"
                                                class="text-decoration-underline">
                                                show
                                            </a></p>
                                        {{-- <p><a href="{{ route('company.projectPermission.list', $data->id) }}"
                                                class="text-decoration-underline">
                                                Edit
                                            </a></p> --}}
                                    @else
                                        <p>No members found <a href="{{ route('company.projectPermission.list') }}"
                                                {{-- href="{{ route('company.projectPermission.approval.add', $data->id) }}" --}} class="text-decoration-underline">
                                                Setup
                                            </a></p>
                                    @endif
                                </div>
