                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-4">
                                        ...
                                        <div class="form-check ">
                                            <input class="form-check-input" type="checkbox" id="view_<?=$value->id?>"
                                                name="permission[<?=$value->id?>][view]" value="view"
                                                <?=(isset($tempArr[$value->id]) && in_array('view',
                                    ...
                                    <div class="col-sm-4">
                                        ...
                                        <div class="form-check ">
                                            <input class="form-check-input" type="checkbox" id="edit_<?=$value->id?>"
                                                name="permission[<?=$value->id?>][edit]" value="edit"
                                                <?=(isset($tempArr[$value->id]) && in_array('edit',
                                            $tempArr[$value->id]))?'checked':''?>>
                                            <label class="form-check-label" for="edit">Edit</label>
                                        </div>
                                        <div class="form-check ">
                                            <input class="form-check-input" type="checkbox" id="delete_<?=$value->id?>"
