                    ...
                    <div class="card-body">
                        ...
                        <div>
                            <form method="POST" action="{{ route('company.roleManagment.addPermission') }}"
                                data-url="{{ route('company.roleManagment.addPermission') }}"
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="form-check form-switch">
                                        <input class="form-check-input" type="checkbox"
                                            ...
                                            value="view" <?= (isset($tempArr[$value->id]) && in_array(
                                                                'view',
                                                                $tempArr[$value->id]
                                                            )) ? 'checked' : '' ?>>
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <div class="form-check form-switch">
                                        <input class="form-check-input" type="checkbox" id="add_<?= $value->id ?>"
                                            ...
                                            <?= (isset($tempArr[$value->id]) && in_array(
                                                'add',
                                                $tempArr[$value->id]
                                            )) ? 'checked' : '' ?>>
                                    ...
                                    <div class="form-check form-switch">
                                        <input class="form-check-input" type="checkbox"
                                            ...
                                            value="edit" <?= (isset($tempArr[$value->id]) && in_array(
                                                                'edit',
                                                                $tempArr[$value->id]
                                                            )) ? 'checked' : '' ?>>
