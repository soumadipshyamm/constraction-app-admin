                            ...
                            <div class="form-row">
                                <div class="col-md-3">
                                    <div class="position-relative form-group">
                                        ...
                                        <input type="text" class="form-control" value="{{ old('f.0.unit', $data->unit ?? '') }}" name="f[0][unit]" id="unit" placeholder=" Enter unit name">
                                        @if ($errors->has('f.0.unit'))
                                        <div class="error">{{ $errors->first('f.0.unit') }}</div>
                                        @endif
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="position-relative form-group">
                                        <label for="unit" class="">Unit Conversion</label>
                                        <select class="form-control" value="{{ old('f.0.unit_coversion') }}" name="f[0][unit_coversion]" id="unit_coversion">
                                            <option value="">----Selecte Unit----</option>
                                            {{ getUnits($data->unit_coversion ?? '') }}
                                        </select>
                                        @if ($errors->has('f.0.unit_coversion'))
                                        <div class="error">{{ $errors->first('f.0.unit_coversion') }}</div>
                                        @endif
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="position-relative form-group">
                                        ...
                                        <input type="text" class="form-control" name="f[0][unit_coversion_factor]" value="{{ old('f.0.unit_coversion_factor', $data->unit_coversion_factor ?? '') }}" id="unit_coversion_factor" placeholder="Enter Unit Coversion factor">
                                        @if ($errors->has('f.0.unit_coversion_factor'))
                                        <div class="error">{{ $errors->first('f.0.unit_coversion_factor') }}</div>
                                        @endif
                                    </div>
                                </div>
                                <div class="col-md-2">
                            ...
                            <div class="form-row">
                                ...
                                <div class="col-md-3">
                                    <div class="position-relative form-group">
                                        ...
                                        <select class="form-control" name="f[${i}][unit_coversion]" id="unit_coversion" value="" >
                                            <option value="">----Selecte Unit----</option>
                                            {{ getUnits('') }}
                                        </select>
                                        @if ($errors->has('f.${i}.unit_coversion'))
                                        <div class="error">{{ $errors->first('f.${i}.unit_coversion') }}</div>
                                        @endif
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="position-relative form-group">
                                        ...
                                        @if ($errors->has('f.${i}.unit_coversion_factor'))
                                        <div class="error">{{ $errors->first('f.${i}.unit_coversion_factor') }}</div>
                                        @endif
                                    </div>
                                </div>
