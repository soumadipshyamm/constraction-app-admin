                                ...
                                <div class="form-row">
                                    <div class="col-md-6">
                                        <div class="position-relative form-group">
                                            ...
                                            <input type="text" class="form-control" name="user_name"
                                                value="{{ old('user_name', $data->companyuser[0]->name ?? '') }}"
                                    ...
                                    <div class="col-md-6">
                                        <div class="position-relative form-group">
                                            ...
                                            <input type="text" class="form-control"
                                                value="{{ old('phone', $data->companyuser[0]->phone ?? '') }}"
                                    ...
                                    <div class="col-md-6">
                                        <div class="position-relative form-group">
                                            ...
                                            <input type="email" class="form-control"
                                                value="{{ old('email', $data->companyuser[0]->email ?? '') }}"
                                                name="email" id="email" placeholder="Enter Email"
                                                {{ !empty($data) ?? $data->companyuser[0]?->email ? 'readonly' : '' }}>
                                            @if ($errors->has('email'))
                                ...
                                <div class="form-row">
                                    <div class="col-md-6">
                                        <div class="position-relative form-group">
                                            ...
                                            <input type="text" class="form-control"
                                                value="{{ old('country', $data->companyuser[0]->country ?? '') }}"
                                    ...
                                    <div class="col-md-6">
                                        <div class="position-relative form-group">
                                            ...
                                            <input type="text" class="form-control" name="city"
                                                value="{{ old('city', $data->companyuser[0]->city ?? '') }}"
                                    ...
                                    <div class="col-md-6">
                                        <div class="position-relative form-group">
                                            ...
                                            <input type="date" class="form-control"
                                                value="{{ old('dob', $data->companyuser[0]->dob ?? '') }}" name="dob"
                                    ...
                                    <div class="col-md-6">
                                        <div class="position-relative form-group">
                                            ...
                                            <input type="text" class="form-control" name="designation"
                                                value="{{ old('designation', $data->companyuser[0]->designation ?? '') }}"
