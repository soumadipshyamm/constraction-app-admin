            ...
            <div class="materials_tab">
                <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                    <li class="nav-item" role="presentation">
                        <button class="nav-link active" id="pills-materials-tab" data-bs-toggle="pill" data-bs-target="#pills-materials" type="button" role="tab" aria-controls="pills-materials" aria-selected="true">Materials List</button>
                    </li>
                    <li class="nav-item" role="presentation">
                        <button class="nav-link" id="pills-bulkupload-tab" data-bs-toggle="pill" data-bs-target="#pills-bulkupload" type="button" role="tab" aria-controls="pills-bulkupload" aria-selected="false">Bulk Upload of Material</button>
                    </li>
                    <li class="nav-item" role="presentation">
                        <button class="nav-link" id="pills-openingstock-tab" data-bs-toggle="pill" data-bs-target="#pills-openingstock" type="button" role="tab" aria-controls="pills-openingstock" aria-selected="false">Opening Stock</button>
                    </li>
                </ul>
                <!-- **********************************Materials List********************************************************************** -->
                <div class="tab-content" id="pills-tabContent">
                                                    ...
                                                    <table class="mb-0 table dataTable">
                                                        ...
                                                        <tbody class="datatable_body">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <a href="{{ route('company.materials.edit',$data->uuid) }}"><i class="fa fa-edit" style="cursor: pointer;" title="Edit"></i></a>

                                                                    <a class="deleteData text-danger" data-uuid="{{ $data->uuid }}" data-table="materials" data-model="company" href="javascript:void(0)"><i class="fa fa-trash-alt" style="cursor: pointer;" title="Remove">
                                                                        </i></a>
                                                                </td>
                                                            </tr>
                                                            @empty
                    ...
                    <div class="tab-pane fade" id="pills-bulkupload" role="tabpanel" aria-labelledby="pills-bulkupload-tab">
                        <div class="projecttable_box copybulk_head">
                    ...
                    <!-- ***************************Opening Stock************************************************************* -->
                    <div class="tab-pane fade" id="pills-openingstock" role="tabpanel" aria-labelledby="pills-openingstock-tab">
                        <div class="projecttable_box copybulk_head">
                            <!-- <div class="comp-top"> -->
                            <div class="materials_tab">
                                <ul class="nav nav-tabs" id="myTab" role="tablist">
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link active" id="home-tab" data-bs-toggle="tab" data-bs-target="#home" type="button" role="tab" aria-controls="home" aria-selected="true">Bulk Upload Opening Materials</button>
                                    </li>
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link" id="profile-tab" data-bs-toggle="tab" data-bs-target="#profile" type="button" role="tab" aria-controls="profile" aria-selected="false">Available Opening Stock</button>
                                    </li>
                                </ul>
                                    ...
                                    <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                                        <div class="tablesec-head blukup_head">
                                            <div class="row">
                                                <div class="col-md-7">
                                                    <div class="excel_btnbox">
                                                        <a href="{{ route('company.materials.exportOpeningStock') }}" class="excelbtn"><span><img src="{{ asset('company_assets/images/excel.png') }}" class="img-fluid" alt="excel"></span>Export
                                                            Materials Data</a>
                                                    </div>
                                                </div>
                                            </div>
                                            <hr>
                                            <form action="{{ route('company.materials.importOpeningStock') }}" method="POST" enctype="multipart/form-data">
                                                @csrf
                                                <div class="form-row">
                                                    <div class="col-md-4">
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="position-relative form-group">
                                                            <label for="opeing_stock_date" class="">Opening
                                                                Date</label>
                                                            <input type="date" class="form-control" value="{{ old('opeing_stock_date') }}" name="opeing_stock_date" id="opeing_stock_date">
                                        ...
                                        <div class="projecttable_box copybulk_head">
                                            ...
                                            <div class="form-row" id="searchingProjectStore">
                                                <div class="col-md-4">
                                                    <div class="position-relative form-group">
                                                        <label for="class" class="">Project</label>
                                                        <select class="form-control" value="{{ old('project') }}" name="project" id="openigProject">
                                                            <option value="">----Select Project----</option>
                                                            {{ getProject('') }}
                                                        </select>
                                                        @if($errors->has('project'))
                                                ...
                                                <div class="col-md-4">
                                                    <div class="position-relative form-group">
                                                        <label for="warehouses" class="">Store/Warehouses</label>
                                                        <select class="form-control" value="{{ old('warehouses') }}" name="warehouses" id="openigWarehouses">
                                                            <option value="">----Select Store/Warehouses----
                                                            </option>
                                                            {{getStoreWarehouses('')}}
                                                        </select>
