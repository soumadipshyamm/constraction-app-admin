...
<div class="app-main__outer">
    <div class="app-main__inner card">
        ...
        <div class="dashboard_body">
            ...
            <form method="POST" action="{{ route('company.materials.add') }}" data-url="{{ route('company.materials.add') }}" class="formSubmit fileUpload" enctype="multipart/form-data" id="UserForm">
                @csrf
                ...
                <div class="form-row">
                    <div class="col-md-6">
                        <div class="position-relative form-group">
                            ...
                            <select class="form-control" value="{{ old('class',$data->class??'') }}" name="class" id="class">
                    ...
                    <div class="col-md-6">
                        <div class="position-relative form-group">
                            ...
                            <input name="name" id="name" class="form-control" value="{{ old('name',(!empty($data)?$data->name:'')) }}" placeholder=" Enter Materials Name">
                            @if($errors->has('name'))
                ...
                <div class="form-row">
                    ...
                    <div class="col-md-6">
                        <div class="position-relative form-group">
                            ...
                            <input name="specification" id="specification" class="form-control" value="{{ old('specification',(!empty($data)?$data->Specification:'')) }}" placeholder=" Enter specification">
