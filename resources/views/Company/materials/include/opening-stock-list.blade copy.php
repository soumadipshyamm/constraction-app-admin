                            ...
                            <table class="mb-0 table dataTable">
                                ...
                                <tbody class="datatable_body">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('company.materials.stockedit',$data->uuid) }}"><i class="fa fa-edit" style="cursor: pointer;" title="Edit"></i></a>

                                            <!-- <a href="{{ route('company.materials.issuestockedit',$data->uuid) }}"><i
                                                    class="fa fa-edit" style="cursor: pointer;" title="Edit"></i></a> -->

                                            <a class="deleteData text-danger" data-uuid="{{ $data->uuid }}" data-table="material_opening_stocks" data-model="company" href="javascript:void(0)"><i class="fa fa-trash-alt" style="cursor: pointer;" title="Remove">
                                                </i></a>
                                        </td>
                                    </tr>
                                    @empty
