        ...
        <div class="app-page-title">
            <div class="page-title-wrapper">
                ...
                <div class="page-title-actions">
                    ...
                    <a href="{{ route('company.userManagment.add') }}" type="button" class="btn-shadow btn btn-info">
                        Add User
                    </a>
                    {{-- @endif --}}
                </div>
            ...
            <div class="col-lg-12">
                <div class="main-card mb-3 card">
                    <div class="card-body">
                        ...
                        {{-- <form id="filter_form" action="{{ route('company.userManagment.list') }}" method="GET"
                            class="form-inline">
                            <div class="row">
                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive table-scrollable" id="load_content">
                            @include('Company.userManagment.include.user-list')
                        </div>
                    </div>
                </div>
            </div>
