...
<div class="app-main__outer">
    <div class="app-main__inner card">
        ...
        <div class="dashboard_body">
            ...
            <form method="POST" action="{{ route('company.activities.add') }}" data-url="{{ route('company.activities.add') }}" class="formSubmit fileUpload" enctype="multipart/form-data" id="UserForm">
                @csrf
                ...
                <div class="form-row">
                    <div class="col-md-4 ">
                        <div class="position-relative form-group typeAdd">
                            ...
                            <select class="form-control activiesType" value="{{ old('type', $data->type ?? '') }}" name="type" id="type">
                                <option value="">---Select Activites---</option>
                                <option value="heading" {{ isset($data) && $data->type == 'heading' ? 'selected' : '' }}>Heading</option>

                                <option value="activites" {{ isset($data) && $data->type == 'activites' ? 'selected' : '' }}>Activites
                                </option>
                            </select>
                            @if ($errors->has('type'))
    ...
    $(document).ready(function() {
        ...
        $('.activiesType').on('change', function(e) {
            ...
            if (type === 'heading') {
                ...
                $(".activites").html(activiteFieldHtml());
            }
        });
