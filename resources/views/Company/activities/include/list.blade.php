                ...
                <div class="strucbhelr_body">
                    <div class="strucbhe_left">
                        <div class="strucbhe_sing">
                            <input type="checkbox"  name="headactivity[{{ $activity->id }}]" value="{{ $activity->id }}" class="checkactivity"
                                data-id={{ $activity->id }}>
                        </div>
                ...
                @if (count($activity->children) > 0)
                    @forelse ($activity->children as $subactivity)
                        ...
                        <div class="strucbhe_subbox sub_heading">
                            <div class="strucbhe_sing">
                                <input type="checkbox" name="subactivite[{{ $subactivity->id }}]" value="{{ $subactivity->id }}"  class="checkactivity"
                        ...
                        @if (count($subactivity->children) > 0)
                            ...
                            @forelse ($subactivity->children as $childActivity)
                                ...
                                <div class="strucbhe_subbox">
                                    <div class="strucbhe_sing">
                                        <input type="checkbox"  name="activites[{{ $childActivity->id }}]" value="{{ $childActivity->id }}" class="checkactivity"
