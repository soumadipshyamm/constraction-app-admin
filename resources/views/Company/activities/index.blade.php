...
@push('styles')
    <style>
        ...
        .activites {
            margin-top: 1rem;
            /* Spacing for activities section */
        }
    ...
    <div class="modal-dialog modal-lg"> <!-- Set modal size to large -->
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="exampleModalLabel">Copy Activities To</h1>
                    ...
                    <div class="row">
                        <div class="col-lg-5">
                            <div class="position-relative form-group">
                                <label for="to_project" class="">Project To</label>
                        ...
                        <div class="col-lg-6">
                            <div class="position-relative form-group">
                                <label for="to_subproject" class="">Sub Project To</label>
...
{{-- <div class="modal fade" id="myModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="exampleModalLabel">Copy Activites To</h1>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <form action="{{ route('company.activities.addCopyActivites') }}" method="post"
                        ...
                        <div class="col-lg-6">
                            <div class="position-relative form-group ">
                                ...
                                <select class="form-control mySelect2" value="{{ old('to_subproject') }}"
                                    ...
                                    <option value="">----Select SubProject to----</option>
                                </select>
                                @if ($errors->has('to_subproject'))
                                    <div class="error">{{ $errors->first('to_subproject') }}</div>
                                @endif
...
@push('scripts')
    <script>
        ...
        $(document).on("click", ".add_newbox", function() {
            ...
            var content = ''
            if (type == 'heading') {
                content = `<div class="structureb_head t-souma">
                        <a href="#">
        ...
        $(document).on('click', '.editData', function() {
            ...
            if (type === 'heading') {
                // alert('Heading cannot be edited.');

                // Create the content for the heading
                const content = `
                ...
                // Hide the add new box
                $('.strucbhe_subbox .strucbhe_sing .add_newbox').hide();
                // }
                // } else if (type == 'subheading') {
                //     // alert('subheading cannot be edited');

                //     content = `<div class="structureb_sub" style="display: block">
            //         <div class="strucbhe_subbox sub_heading">
            //         <div class="strucbhe_sing ">
            //         <a title="update" class="update_data"><i class="fa-regular fa-pen-to-square"  style="cursor: pointer;"></i></a>
            //         <a title="delete" class="remove-input-field-update"><i class="fa fa-times"
            //                                         style="cursor: pointer;" title="Remove">
            //                                     </i>R</a>
            //         </div>
            //         <div class="strucbhe_sing">
            ...
            //     </div>`
                ...
                // alert('childrennn cannot be edited.');
        ...
        function copyActivity(value, key) {
            ...
            html += `<input type="hidden" name="id[${i}]" id="id_${i}" value="${value ? value.id : ''}">
        ...
        $('.activiesType').on('change', function(e) {
            ...
            var subproject = $('#to_subproject').val();
            var type = $(this).val();
            // alert(projectId);
            if (type === 'heading') {
