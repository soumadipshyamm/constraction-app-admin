...
@push('scripts')
    <script>
        ...
        function copyActivity(value, key) {
            var i = key;
            var html = `<div class="position-relative form-group">`;
            html += `
            <input type="hidden" name="id[${i}]" id="id" value="${value.id}" readonly>
            <input name="name[${i}]" id="name" value="${value.activities}" readonly>
            <input name="copyType[${i}]" id="copyType" value="${value.type}" readonly>`;
            html += `</div>`;
            return html;
        }
